/* v4 — the loyal card: 3D tilt + confetti.
   Same behaviour as the current build's script.js; kept separate so /v4/
   stays self-contained. Fine pointers only — a tilt you can't aim is noise. */
(function () {
